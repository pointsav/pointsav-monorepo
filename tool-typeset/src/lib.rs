...
//! (BRIEF-tool-accounting-pro-01.md decisions 34-35, project-accounting,
//! business-admin): one internal Doc tree, two independent backends never
//! HTML-to-PDF conversion, standard-14 fonts only, cells carry pre-formatted
//! strings never Money/f64 -- what keeps this crate domain-agnostic.
//!
...
//! scaffold copy -- nothing crosses the business-admin boundary. Any project-*
//! archive may path-dependency on this crate.
