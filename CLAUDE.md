...
4. Call `get_session_brief(role="totebox", archive="project-source")` — replaces inbox, NOTAM, session-context reads
...
`get_session_brief(role="totebox", archive="project-source")` replaces manually reading
