...
/*
 * totebox_hello.c — os-totebox Phase H1 seL4 rootserver, hello milestone.
 *
 ...
 *
 * Referenced by moonshot-toolkit/examples/os-totebox-hello.toml.
 * Parallel to console_hello.c which gates the os-console Phase H1 milestone.
 *
...
static const char banner[] =
    "\r\n"
    "=== os-totebox seL4 rootserver ===\r\n"
    "Hello from os-totebox seL4 PD\r\n"
