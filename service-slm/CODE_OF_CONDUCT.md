...
service-slm project a harassment-free experience for everyone, regardless of
...
Project maintainers (see [MAINTAINERS.md](./MAINTAINERS.md)) are responsible
for clarifying and enforcing standards of acceptable behaviour and will take
...
repositories, issues, pull requests, discussions — and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be
reported to the project maintainers at peter@woodfinegroup.com. All
