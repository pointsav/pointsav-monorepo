...
- [ ] **woodfine-bim-library push to origin** — 3 commits recreated (6a9fa1b/302238f/94fc8f6); push blocked by auto-mode; operator must authorize: `git -C /srv/foundry/clones/project-bim/woodfine-bim-library push origin main` [2026-06-04 totebox@claude-code]
- [ ] **Restart bim service** — `sudo systemctl restart local-bim-orchestration` — picks up new key-plans/ IFC files [2026-06-04 totebox@claude-code]
