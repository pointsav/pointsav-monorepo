...
const WORDMARK_SVG_WOODFINE: &str = r##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 40" class="brand__svg" role="img" aria-label="Woodfine Capital Projects"><title>Woodfine Capital Projects</title><text x="0" y="30" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="24" font-weight="800" fill="currentColor" letter-spacing="-0.03em">WOODFINE CAPITAL PROJECTS</text></svg>"##;
    ...
    html! {
        ...
        html lang=(locale.lang_attr())
            ...
            body {
                ...
                // Phase 10 — Continue-reading strip populated by wiki.js from localStorage
