/* generated from /home/mathew/Foundry/factory-pointsav/pointsav-monorepo/vendor-sel4-kernel/src/include/arch/x86/arch/object/structures.bf */
...
cap_io_space_cap_new(uint64_t capDomainID, uint64_t capPCIDevice) {
    ...
    /* fail if user has passed bits that we will override */  
    assert(((uint64_t)cap_io_space_cap & ~0x1full) == ((1 && ((uint64_t)cap_io_space_cap & (1ull << 47))) ? 0x0 : 0));  
    assert((capDomainID & ~0xffffull) == ((1 && (capDomainID & (1ull << 47))) ? 0x0 : 0));  
    assert((capPCIDevice & ~0xffffull) == ((1 && (capPCIDevice & (1ull << 47))) ? 0x0 : 0));
...
cap_io_space_cap_get_capDomainID(cap_t cap) {
    uint64_t ret;
    /* fail if union does not have the expected tag */
    assert(((cap.words[0] >> 59) & 0x1f) == cap_io_space_cap);
...
cap_io_page_table_cap_new(uint64_t capIOPTIsMapped, uint64_t capIOPTLevel, uint64_t capIOPTMappedAddress, uint64_t capIOPTIOASID, uint64_t capIOPTBasePtr) {
    ...
    /* fail if user has passed bits that we will override */  
    assert(((uint64_t)cap_io_page_table_cap & ~0x1full) == ((1 && ((uint64_t)cap_io_page_table_cap & (1ull << 47))) ? 0x0 : 0));  
    assert((capIOPTIsMapped & ~0x1ull) == ((1 && (capIOPTIsMapped & (1ull << 47))) ? 0x0 : 0));  
    assert((capIOPTLevel & ~0xfull) == ((1 && (capIOPTLevel & (1ull << 47))) ? 0x0 : 0));  
    assert((capIOPTMappedAddress & ~0xffffffffffffull) == ((1 && (capIOPTMappedAddress & (1ull << 47))) ? 0xffff000000000000 : 0));  
    assert((capIOPTIOASID & ~0xffffull) == ((1 && (capIOPTIOASID & (1ull << 47))) ? 0x0 : 0));  
    assert((capIOPTBasePtr & ~0xffffffffffffull) == ((1 && (capIOPTBasePtr & (1ull << 47))) ? 0xffff000000000000 : 0));
...
cap_io_page_table_cap_get_capIOPTIOASID(cap_t cap) {
    uint64_t ret;
    /* fail if union does not have the expected tag */
    assert(((cap.words[0] >> 59) & 0x1f) == cap_io_page_table_cap);
...
cap_io_page_table_cap_set_capIOPTIsMapped(cap_t cap, uint64_t v64) {
    ...
    assert(((cap.words[0] >> 59) & 0x1f) == cap_io_page_table_cap);
    /* fail if user has passed bits that we will override */
    assert((((~0x10000000000000ull >> 52 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
cap_io_page_table_cap_set_capIOPTLevel(cap_t cap, uint64_t v64) {
    ...
    assert(((cap.words[0] >> 59) & 0x1f) == cap_io_page_table_cap);
    /* fail if user has passed bits that we will override */
    assert((((~0xf000000000000ull >> 48 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
