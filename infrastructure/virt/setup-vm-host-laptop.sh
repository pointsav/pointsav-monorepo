...
#   NODE_ID=laptop-a-1  WG_IP=10.8.0.6  bash <(curl -s <operator>@10.8.0.9:'<path-to-workspace>/clones/project-infrastructure/infrastructure/virt/setup-vm-host-laptop.sh')
