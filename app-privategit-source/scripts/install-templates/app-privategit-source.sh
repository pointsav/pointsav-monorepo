...
# install.sh — PointSav PrivateGit Source Server installer
# curl -fsSL https://software.pointsav.com/releases/app-privategit-source/install.sh | bash
set -euo pipefail

PRODUCT="app-privategit-source"
VERSION="latest"
PLATFORM="x86_64-unknown-linux-gnu"
BINARY_NAME="app-privategit-source"
