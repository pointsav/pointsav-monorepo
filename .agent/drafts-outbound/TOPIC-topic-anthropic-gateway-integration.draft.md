...
target_path: topic-anthropic-gateway-integration.md
audience: internal
...
research_provenance: |
  Source: service-slm/docs/topic-anthropic-gateway-integration.md (original research session 2026-05-16)
research_inline: true
notes_for_editor: |
  Anthropic Messages API gateway integration — shim architecture, tier routing, model mapping.
