...
target_repo: vendor/pointsav-monorepo
target_path: service-content/ARCHITECTURE.md (REBUILD)
audience: foundry-engineering
...
research_provenance: master-direct-code-read + cluster-research-iter-24-graph-db-section
