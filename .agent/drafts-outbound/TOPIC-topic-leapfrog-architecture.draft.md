...
target_path: topic-leapfrog-architecture.md
audience: internal
...
research_provenance: |
  Source: service-slm/docs/topic-leapfrog-architecture.md (original research session 2026-05-16)
research_inline: true
notes_for_editor: |
  Leapfrog 2030 architecture — multi-Yo-Yo pipeline, Trainer + Graph Extractor.
