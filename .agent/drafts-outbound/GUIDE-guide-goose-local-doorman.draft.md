...
target_path: guide-goose-local-doorman.md
audience: internal
bcsc_class: no-disclosure-implication
authored: 2026-05-29
authored_by: project-intelligence Totebox (claude-sonnet-4-6, session 6)
...
research_provenance: |
  ...
  Tool invocation test revealed OLMo 7B model limitation (text response vs. tool_use).
...
- `service-slm/NEXT.md` — current §7 learning loop verification status
