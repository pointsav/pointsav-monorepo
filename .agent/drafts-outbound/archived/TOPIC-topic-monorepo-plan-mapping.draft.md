...
target_path: topic-monorepo-plan-mapping.md
audience: internal
...
research_provenance: |
  Source: service-slm/docs/topic-monorepo-plan-mapping.md (original research session 2026-05-16)
research_inline: true
notes_for_editor: |
  Sovereign routing plan physical file map — where each sprint component lives in the monorepo.
