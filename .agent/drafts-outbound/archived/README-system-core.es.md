...
de Capacidades**. Define los tipos de datos puros y las primitivas
criptográficas que utilizan todos los demás cajones `system-*` y
`moonshot-*`. No depende de ningún otro cajón del espacio de trabajo;
todos los que gestionan capacidades dependen de él.
...
canónico en inglés ([README.md](./README.md)).
