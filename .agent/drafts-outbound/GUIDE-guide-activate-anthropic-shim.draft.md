...
target_path: guide-activate-anthropic-shim.md
audience: internal
...
research_provenance: |
  Source: service-slm/docs/guide-activate-anthropic-shim.md (original research session 2026-05-16)
research_inline: true
notes_for_editor: |
  Operations guide — activating the Anthropic Messages API shim (Sprint 0a/1).
