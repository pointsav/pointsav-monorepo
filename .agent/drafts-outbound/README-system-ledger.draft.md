...
notes_for_editor: |
  README refresh per v0.1.31 Reverse-Funnel pattern. system-ledger 0.1.5 ->
  0.2.0 (breaking trait-sig change in Phase 1A.4) -> 0.2.1 (bench refresh).
  Crate state-machine consumer of system-core's Capability Ledger Substrate
  primitives; the kernel-side ledger consultation pattern. Audience is
  vendor-public.
---
...
- Sibling crate `../system-core/` — owns the data primitives this crate
  consumes.
- `~/Foundry/DOCTRINE.md` §II claim #33 — The Capability Ledger
