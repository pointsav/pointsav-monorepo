...
refined_by: totebox@project-editorial
...
refined: 2026-05-28T00:00:00Z
refined_by: totebox@project-editorial claude-code
notes_for_command: |
  Language-cleared operational guide for app-privategit-workbench deployment.
  Commit to woodfine-fleet-deployment at vault-privategit-source/guide-workbench-setup.md
  via admin-tier commit (mcorp-administrator). English-only per §14 (operational file).
