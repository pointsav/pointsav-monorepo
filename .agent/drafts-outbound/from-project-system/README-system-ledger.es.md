...
consulta al libro mayor descrito en el Sustrato del Libro Mayor de
Capacidades.
...
vive en el documento canónico en inglés ([README.md](./README.md)).
...
## IV. Ceremonia de traspaso de ápice (N+3+)

`system-ledger` implementa la ceremonia de transferencia de propiedad
especificada en la especificación del Sustrato del Libro Mayor de
Capacidades §4:
...
- **Sustrato del Libro Mayor de Capacidades** — ancla constitucional
  para el registro Merkle de raíz del cliente. Especifica los
  invariantes que implementa esta crate: §3.1 + §4 + §5.
- Diseño del libro WORM §2 — pila de cuatro capas.
- `topic-merkle-proofs-as-substrate-primitive.md` (publicado,
