...
> **README contamination note (2026-06-08):** This archive is `project-design`, not
> `project-knowledge`. The body of this README below the active-briefs table was bulk-copied
> from another archive. The active-briefs table below is authoritative for project-design.
> Contaminated sections are left in place for Command-scope cleanup.

## Active briefs

| File | Title | Updated |
|---|---|---|
| BRIEF-app-privategit-design.md | design.pointsav.com — Carbon-style redesign + v0.1.0 recovery state | 2026-06-08 |
