...
- **File:** `archived/GUIDE-provision-marketing-site.draft.md`
- **Status:** PLACED — `b84b131` (2026-06-03) — `woodfine-fleet-deployment/media-marketing-landing/guide-provision-marketing-site.md`; Command ACK `command-20260603-ack-guide-routing-batch-2-complete-7-gui`; source draft archived
...
- **File:** `archived/GUIDE-deployment-marketing-site.draft.md`
- **Status:** PLACED — `b84b131` (2026-06-03) — `woodfine-fleet-deployment/media-marketing-landing/guide-deployment-marketing-site.md`; source draft archived
...
### A37b — GUIDE batch-2 placement confirmation (2026-06-03)
- **Status:** ALL PLACED — `b84b131` (WFD, pushed). Command ACK verified; 9 source drafts archived from drafts-outbound this session.
- **Placed guides + canonical paths:**
  - `guide-moonshot-toolkit-phase1c-build-setup.md` → `project-system/` (A14)
  - `guide-regional-market-topic-production.md` → `gateway-orchestration-gis-1/` (A21)
  - `guide-location-intelligence-data-collection.md` → `gateway-orchestration-gis-1/`
  - `guide-provision-marketing-site.md` → `media-marketing-landing/` (A38)
  - `guide-deployment-marketing-site.md` → `media-marketing-landing/` (A39)
  - `guide-vm-mediakit-provision.md` → `fleet-infrastructure-cloud/` (A10)
  - `guide-vm-mediakit-service-migration.md` → `fleet-infrastructure-cloud/` (A11)
  - `guide-ppn-first-deployment.md` → `fleet-infrastructure-cloud/`
  - `guide-vm-infrastructure-resource-pool.md` → `fleet-infrastructure-cloud/`

### A41 — project-software distribution dispatch [HELD — disclosure conflict]
- **Files (drafts-outbound, unmodified):** `TOPIC-software-distribution-substrate.md`, `TOPIC-crypto-license-sales-architecture.md`, `TOPIC-private-git-paid-customer-endpoint.md`, `GUIDE-software-distribution-operations.md` (source drafts in project-software drafts-outbound)
- **Status:** HELD (2026-06-03) — all 3 TOPICs are `bcsc_class: internal-only` but dispatched to the public wiki (content-wiki-documentation). Operator-confirmed disposition: hold + flag, do not publish. Reply sent to project-software (msg: project-editorial-20260603-software-dispatch-hold) requesting re-classification, an internal destination, or withdrawal.
- **Source:** project-software (`project-software-20260530-editorial-sweep`, supersedes `-20260529-topic-drafts`)
- **Blocker:** internal-only content (wallet key handling, pricing, USDC contract address, CRA tax specifics) cannot publish to documentation.pointsav.com. GUIDE held with TOPICs to keep dispatch together; receipt-schema ratification also pending. SCRIPT-deploy-soft-releases.sh is Command-scoped (not editorial).
