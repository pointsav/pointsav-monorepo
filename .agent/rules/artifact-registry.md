...
- J1: benchmark placeholders [T][N][L] need empirical data; Peter + Mathew + Jennifer ORCID IDs; Peter email address unknown (do not use corporate.secretary@woodfinegroup.com)
