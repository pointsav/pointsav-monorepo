...
phase: 0
sub_phase: 0-vocabulary-baseline
status: in-progress
safe_to_resume: true
unsafe_reason: ""
...
- task: 0-vocabulary-baseline — extract vocabulary-baseline.tsv from all three wiki repos + runtime surfaces
- inputs: pointsav-monorepo/service-content/seeds/Domains.json, ontology/*.csv, content-wiki-documentation/reference/glossary-documentation.md, content-wiki-corporate/, content-wiki-projects/
